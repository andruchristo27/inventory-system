                ...
                <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-2xl">
                    ...
                    <form action="/post" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="nama_barang" name="nama_barang" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                        </div>
                        <div class="mb-4">
                            <label for="nama_user" class="block text-gray-700 font-medium mb-2">Nama User</label>
                            <input type="text" id="nama_user" name="nama_user" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                        </div>
                        <div class="mb-4">
                            <label for="tgl_masuk_barang" class="block text-gray-700 font-medium mb-2">Tanggal Masuk Barang</label>
                            <input type="date" id="tgl_masuk_barang" name="tgl_masuk_barang" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                        </div>
